    ...
    <?php
            ...
            {   
                ...
                <div class="container my-4">   
                    <h2 class="titulo text-center">Publicaciones</h2>
                    <p class="text-center">¿Desea publicar algún proyecto?</p>
                    <div class="abs-center">
                        <a href="formPublicacion.php" class="btn btn-danger ml-8">Publicar</a>
                    </div>
                     ...
                     <div class="card col m-1 bg-light">
                         ...
                         <div class="card-body">
                             <div class="row mb-2">
                                 ...
                                 <h5 class="card-title col"><?= $objeto->rol ?></h5>
                                 <h5 class="card-title col"><?= $objeto->fecha ?></h5>
                             </div>
                           
                                
                                <p class="card-text"><?= $objeto->descripcion ?></p>
                                <a style="btn tbn-outline-primary" href="mailto:<?= $objeto->correo ?>">Enviar Correo</a>
                            </div>
                        </div>
